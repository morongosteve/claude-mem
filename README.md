...
1. **Lifecycle Hooks** - Setup, SessionStart, UserPromptSubmit, PostToolUse, and Stop events drive capture and context injection (registered in `plugin/hooks/hooks.json`)
